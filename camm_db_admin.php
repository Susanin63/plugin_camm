 ...
 */
 ...
 $rezult=1;
 	...
 	//business logic
 	if ($rezult==1) {
 		$tree_type = (string) (isset_request_var('type') ? get_nfilter_request_var('type') : "snmptt");
 ...
 $total_rows=0;
	...
	camm_input_validate_input_regex(get_request_var_request("only_new", "false"), "/^(false|true)$/");
 	...
 	if ($rezult==1) {
		...
		$only_new = (boolean) (isset_request_var('only_new') ? (get_nfilter_request_var('only_new') == "true") : false);
 		...
 		$type = (string) (isset_request_var('type') ? get_nfilter_request_var('type') : get_nfilter_request_var('type'));
 ...
 /* ==================================================== */
 	...
 	if ($rezult==1){
 		if ($cacti_camm_components['snmptt']) {
 			if ( isset_request_var('ids')){
 			   $ids = get_nfilter_request_var('ids'); // Get our array back and translate it :
 ...
 /* ==================================================== */
 	...
 	if ($rezult==1){
 		if ( isset_request_var('id')){
 		   $ids = get_nfilter_request_var('id'); // Get our array back and translate it :
 		   $ids = camm_JDecode(stripslashes($ids));
 ...
 /* ==================================================== */
 	...
 	if ($rezult==1){
 		if ( isset_request_var('id')){
			$n_name = (string) (isset_request_var('n_name') ? get_nfilter_request_var('n_name') : 'no_name');
			$ids = get_nfilter_request_var('id'); // Get our array back and translate it :
			$ids = camm_JDecode(stripslashes($ids));
 ...
 if ( isset_request_var('data')){
 	
    $ids = get_nfilter_request_var('data'); // Get our array back and translate it :
 ...
 if ( isset_request_var('data')){
    ...
    $n_settings = get_nfilter_request_var('data'); // Get our array back and translate it :
 ...
 /* ==================================================== */
 	...
 	if ($rezult==1){
 		...
 		$tree_id = (integer) (isset_request_var('id') ? get_nfilter_request_var('id') : '0');
 		$act_id = (string) (isset_request_var('a_id') ? get_nfilter_request_var('a_id') : '');
		$act_v = (integer) (isset_request_var('a_v') ? get_nfilter_request_var('a_v') : '0');
